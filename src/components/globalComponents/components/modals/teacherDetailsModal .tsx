...
export const TeacherDetailsModal:React.FC<TeacherDetailsModalProps> = ({teacherEmail,setDisplayModal}) =>{
    ...
    return(
        <div className="student-details-modal">
            ...
            <div className="sdm-header">
                <div className="sdm-title"> <p style={{fontSize:"25px"}}>Teacher Details</p></div>
